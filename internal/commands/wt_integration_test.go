...
// runWtCmd executes a sub-command on the wtm wt command group.
...
func TestWtCreateAndClean(t *testing.T) {
	...
	// Create — pass --from main to bypass the interactive wizard
	...
	if _, err := os.Stat(wtPath); err != nil {
		// Tree paths are sanitised: slashes become dashes
...
// setupMinimalConfig writes the minimal .wtm/config.toml required by loadConfig.
